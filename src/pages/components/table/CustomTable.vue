  ...
  <div ref="table" :id="id" class="advanced-table">
    <a-spin :spinning="loading">
      <div :class="['header-bar', size]">
        <div class="title" v-show="isShowAdd">
...
<script>
import ActionSize from "@/pages/components/table/ActionSize";
import ActionColumns from "@/pages/components/table/ActionColumns";
import SearchArea from "@/pages/components/table/SearchArea";
export default {
  name: "AdvanceTable",
